...
dpath = "./catalog/jplus-star-colours.csv"
ncol = rep("numeric", 23)
...
for (i in 1:length(label)) {label[i] = 2}  # 1 ssp, 2 star
...
sspPath = "./synth/convolved_mags_04082020.dat"
